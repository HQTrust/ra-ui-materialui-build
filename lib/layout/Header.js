...
var styles = function styles(theme) {
    ...
    return {
        root: (_root = {}, (0, _defineProperty3.default)(_root, theme.breakpoints.down('xs'), {
            flexDirection: 'column'
        }), (0, _defineProperty3.default)(_root, 'display', 'flex'), (0, _defineProperty3.default)(_root, 'justifyContent', 'space-between'), _root),
        header: (0, _defineProperty3.default)({}, theme.breakpoints.down('xs'), {
            marginBottom: 24
        })
    };
};
...
var Header = function Header(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_ViewTitle2.default, { className: classes.header, title: title }),
