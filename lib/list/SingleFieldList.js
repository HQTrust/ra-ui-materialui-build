...
var sanitizeRestProps = function sanitizeRestProps(_ref) {
    var currentSort = _ref.currentSort,
        ...
        isFullWidthVisible = _ref.isFullWidthVisible,
        linkToResource = _ref.linkToResource,
        showFullWidthTableRow = _ref.showFullWidthTableRow,
        showRowOverlay = _ref.showRowOverlay,
        props = (0, _objectWithoutProperties3.default)(_ref, ['currentSort', 'isLoading', 'isFullWidthVisible', 'linkToResource', 'showFullWidthTableRow', 'showRowOverlay']);
    return props;
};
    ...
    (0, _createClass3.default)(SingleFieldList, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                linkBasePath = _props.linkBasePath,
                linkType = _props.linkType,
                rest = (0, _objectWithoutProperties3.default)(_props, ['classes', 'className', 'ids', 'data', 'resource', 'basePath', 'children', 'linkBasePath', 'linkType']);
            ...
            return _react2.default.createElement(
                ...
                ids.map(function (id) {
                    var record = data[id];
                    var resourceLinkPath = !linkType ? false : (0, _raCore.linkToRecord)(linkBasePath || basePath, id, linkType);
