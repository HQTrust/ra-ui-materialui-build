...
var sanitizeRestProps = function sanitizeRestProps(_ref) {
    var TitleClass = _ref.TitleClass,
        ...
        rest = (0, _objectWithoutProperties3.default)(_ref, ['TitleClass', 'children', 'classes', 'className', 'filters', 'pagination', 'actions', 'resource', 'hasCreate', 'hasEdit', 'hasList', 'hasShow', 'filter', 'filterValues', 'crudGetList', 'changeListParams', 'perPage', 'title', 'data', 'ids', 'total', 'totalAll', 'isLoading', 'translate', 'version', 'push', 'history', 'locale', 'location', 'match', 'options', 'params', 'permissions', 'query', 'selectedIds', 'setSelectedIds', 'sort', 'theme', 'toggleItem']);
    return rest;
};
...
var ListView = function ListView(_ref2) {
    var TitleClass = _ref2.TitleClass,
        ...
        rest = (0, _objectWithoutProperties3.default)(_ref2, ['TitleClass', 'actions', 'basePath', 'bulkActions', 'children', 'className', 'classes', 'currentSort', 'data', 'defaultTitle', 'disableSource', 'displayedFilters', 'enableSource', 'enabledSources', 'filters', 'filterValues', 'hasCreate', 'hideActiveFilters', 'showInactiveFilters', 'hideFilter', 'ids', 'isLoading', 'metaSources', 'onSelect', 'onToggleItem', 'onUnselectItems', 'page', 'pagination', 'perPage', 'refresh', 'resource', 'selectedIds', 'setFilters', 'setPage', 'setSort', 'setSourceActive', 'showFilter', 'title', 'total', 'totalAll', 'translate', 'version']);
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                _Card2.default,
                { classes: { root: classes.filtersContainer } },
...
ListView.propTypes = {
    TitleClass: _propTypes2.default.object.isRequired,
