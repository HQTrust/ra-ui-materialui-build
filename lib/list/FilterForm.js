...
var FilterForm = exports.FilterForm = function (_Component) {
    ...
    (0, _createClass3.default)(FilterForm, [{
        ...
        value: function getShownFilters() {
            ...
            var result = filters.filter(function (filterElement) {
            ...
            // unwrap composite inputs
            result = result.map(function (filter) {
                return filter.props.compositeInput ? _react2.default.Children.toArray(filter.props.children) : filter;
            });
...
var getFilterFormKey = exports.getFilterFormKey = function getFilterFormKey(resource, location) {
    return location.pathname + '-' + resource + '-filter-form';
};
