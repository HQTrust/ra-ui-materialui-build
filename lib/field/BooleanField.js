...
var BooleanField = function BooleanField(_ref) {
    var className = _ref.className,
        source = _ref.source,
        record = _ref.record,
        FalseIconClass = _ref.FalseIconClass,
        TrueIconClass = _ref.TrueIconClass,
        falseIconProps = _ref.falseIconProps,
        trueIconProps = _ref.trueIconProps,
        rest = (0, _objectWithoutProperties3.default)(_ref, ['className', 'source', 'record', 'FalseIconClass', 'TrueIconClass', 'falseIconProps', 'trueIconProps']);
