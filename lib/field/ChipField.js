...
var ChipField = function ChipField(_ref) {
    var ChipClass = _ref.ChipClass,
        ...
        rest = (0, _objectWithoutProperties3.default)(_ref, ['ChipClass', 'className', 'classes', 'source', 'record']);

    return _react2.default.createElement(ChipClass, (0, _extends3.default)({
...
ChipField.propTypes = {
    ChipClass: _propTypes2.default.func.isRequired,
