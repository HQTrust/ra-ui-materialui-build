    ...
    (0, _createClass3.default)(TextInput, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                rest = (0, _objectWithoutProperties3.default)(_props, ['className', 'input', 'isRequired', 'label', 'meta', 'options', 'resource', 'source', 'type', 'textField']);
            ...
            return _react2.default.cloneElement(textField, (0, _extends3.default)({
                margin: 'normal',
                type: type,
...
TextInput.propTypes = {
    ...
    textField: _propTypes2.default.element.isRequired,
...
TextInput.defaultProps = {
    ...
    options: {},
    textField: _react2.default.createElement(_TextField2.default, null),
    type: 'text'
};
